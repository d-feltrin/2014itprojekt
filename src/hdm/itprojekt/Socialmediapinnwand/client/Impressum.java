...
public class Impressum extends VerticalPanel {
	...
	"</tr></table>"+
	"<h2>Verantwortlich f�r den Inhalt nach � 55 Abs. 2 RStV:</h2>"+
	"<p>Denis Feltrin<br />"+
	"Calwerstr 24<br />"+
	"706556 Calw</p>"+
	"<h2>Quellenangaben f�r die verwendeten Bilder und Grafiken:</h2>"+
	"<p>� ra2 studio  - Fotolia.com<br />"+
	"�Peter Atkins - Fotolia.com</p>"+
	"<p>�</p>"//+
